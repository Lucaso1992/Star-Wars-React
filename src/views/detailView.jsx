...
function Detail() {
    ...
    const resources = store[params.resource];
    ...
    return (
        <div>
            <Card name={targetResource.name} type={targetResource.type} id={targetResource.id}>
                {targetResource.type === "people" && (
                    <div>
                        <p><strong>Height: </strong>{targetResource.height}</p><p><strong>Mass: </strong>{targetResource.mass}</p><p><strong>Hair Color: </strong>{targetResource.hair_color}</p><p><strong>Skin Color: </strong>{targetResource.skin_color}</p><p><strong>Eye Color: </strong>{targetResource.eye_color}</p><p><strong>Birth year: </strong>{targetResource.birth_year}</p><p><strong>Gender: </strong>{targetResource.gender}</p>
                    </div>
                )};
